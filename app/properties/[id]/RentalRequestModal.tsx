        ...
        {isSuccess ? (
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
              <Send className="w-5 h-5 text-blue-600" /> Confirm Rental Request
            </h2>
            ...
            <div className="bg-blue-50/60 border border-blue-100 rounded-xl p-4 space-y-2">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
                    <MapPin className="w-3 h-3 text-gray-400" /> {property.location}
                  </p>
                </div>
              </div>
              <div className="border-t border-blue-100 pt-2 flex justify-between items-center text-xs">
                ...
                <span className="font-extrabold text-blue-700 text-sm">৳{property.price}</span>
              </div>
            </div>
