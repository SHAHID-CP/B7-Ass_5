  ...
  return (
    <div className="max-w-7xl mx-auto px-3.5 sm:px-6 py-5 sm:py-8 space-y-5 sm:space-y-6">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-gray-100 dark:border-gray-800">
        <div className="p-2 bg-blue-50 dark:bg-blue-950/50 text-emerald-600 dark:text-emerald-400 rounded-xl shrink-0">
      ...
      {/* Main Content Area */}
      {requests.length === 0 ? (
        <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-2xl border border-dashed border-gray-200 dark:border-gray-800 p-6 space-y-2">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800 shadow-xs overflow-hidden">
            ...
            {currentRequests.map((item) => (
              <div key={item.id} className="p-4 space-y-3">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-gray-100 text-xs sm:text-sm">
                ...
                <div className="flex items-center justify-between text-xs pt-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span className="text-gray-500 dark:text-gray-400 text-[11px]">Tenant:</span>
                ...
                <div className="flex items-center justify-between pt-2.5 border-t border-gray-50 dark:border-gray-800 gap-2">
                  <button
                    ...
                    className="cursor-pointer inline-flex items-center gap-1 px-2.5 py-1.5 bg-purple-50 dark:bg-purple-950/50 text-purple-700 dark:text-purple-300 border border-purple-200/60 dark:border-purple-800/60 hover:bg-purple-100 dark:hover:bg-purple-900/50 rounded-lg text-xs font-medium transition"
                  >
                  ...
                  <div className="flex items-center gap-1.5">
                    {updatingId === item.id ? (
                      <Loader2 className="w-4 h-4 animate-spin text-emerald-600 dark:text-emerald-400 my-1" />
                    ) : (
                      <>
                        <button
                          onClick={() => handleStatusUpdate(item.id, 'APPROVED')}
                          disabled={item.status === 'APPROVED'}
                          className="cursor-pointer flex items-center gap-1 px-2.5 py-1.5 bg-emerald-600 dark:bg-emerald-700 hover:bg-emerald-700 dark:hover:bg-emerald-600 text-white rounded-lg text-xs font-medium transition disabled:opacity-40"
                        >
                        ...
                        <button
                          ...
                          className="cursor-pointer flex items-center gap-1 px-2.5 py-1.5 bg-rose-600 dark:bg-rose-700 hover:bg-rose-700 dark:hover:bg-rose-600 text-white rounded-lg text-xs font-medium transition disabled:opacity-40"
                        >
          ...
          <div className="hidden md:block overflow-x-auto">
            <table className="w-full text-left text-xs text-gray-600 dark:text-gray-300">
              <thead className="bg-gray-50/80 dark:bg-gray-800/50 uppercase text-gray-500 dark:text-gray-400 font-semibold border-b border-gray-100 dark:border-gray-800">
                <tr>
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {currentRequests.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/40 transition">
                    <td className="py-3.5 px-4 font-bold text-gray-900 dark:text-gray-100 max-w-[200px] truncate">
                      {item.property?.title || 'N/A'}
                    </td>

                    <td className="py-3.5 px-4 text-gray-600 dark:text-gray-400 max-w-[160px] truncate">
                      {item.property?.location || 'N/A'}
                    </td>
                    ...
                    <td className="py-3.5 px-4">
                      {item.property?.isAvailable ? (
                        <span className="inline-flex items-center gap-1 bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-400 px-2 py-0.5 rounded-full text-[11px] font-semibold border border-emerald-200/60 dark:border-emerald-800/60">
                          <CheckCircle className="w-3 h-3 text-emerald-600 dark:text-emerald-400" /> Yes
                        </span>
                      ) : (
                    ...
                    <td className="py-3.5 px-4 text-center">
                      <button
                        onClick={() => handleOpenTenantHistory(item.tenant?.id)}
                        className="cursor-pointer inline-flex items-center gap-1 px-2.5 py-1 bg-purple-50 dark:bg-purple-950/50 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-800 hover:bg-purple-100 dark:hover:bg-purple-900/50 rounded-lg text-xs font-medium transition"
                    ...
                    <td className="py-3.5 px-4 text-center">
                      {updatingId === item.id ? (
                        <Loader2 className="w-4 h-4 animate-spin mx-auto text-blue-600 dark:text-blue-400" />
                      ) : (
                        <div className="flex justify-center items-center gap-1.5">
                          <button
                            onClick={() => handleStatusUpdate(item.id, 'APPROVED')}
                            disabled={item.status === 'APPROVED'}
                            className="cursor-pointer flex items-center gap-1 px-2.5 py-1 bg-emerald-600 dark:bg-emerald-700 hover:bg-emerald-700 dark:hover:bg-emerald-600 text-white rounded-lg text-xs font-medium transition disabled:opacity-40"
                          ...
                          <button
                            onClick={() => handleStatusUpdate(item.id, 'REJECTED')}
                            disabled={item.status === 'REJECTED'}
                            className="cursor-pointer flex items-center gap-1 px-2.5 py-1 bg-rose-600 dark:bg-rose-700 hover:bg-rose-700 dark:hover:bg-rose-600 text-white rounded-lg text-xs font-medium transition disabled:opacity-40"
          ...
          {/* Pagination Controls */}
          {totalPages > 1 && (
            <div className="px-4 py-3 bg-gray-50/50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between text-xs text-gray-600 dark:text-gray-400">
              <p>
                ...
                of <span className="font-semibold text-gray-900 dark:text-gray-100">{requests.length}</span> entries
              </p>
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="p-1.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 disabled:opacity-40 disabled:hover:bg-white dark:disabled:hover:bg-gray-800 transition cursor-pointer"
                  title="Previous Page"
                >
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-lg border text-xs font-medium transition cursor-pointer ${
                      currentPage === page
                        ? 'bg-emerald-600 text-white border-emerald-600 dark:bg-emerald-600 dark:emerald-blue-600'
      ...
      {historyModalOpen && (
        <div 
          className="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-xs flex items-center justify-center p-3.5 sm:p-4 z-50"
          onClick={() => setHistoryModalOpen(false)}
        >
          <div 
            className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl max-w-md w-full p-5 sm:p-6 space-y-4 relative shadow-xl max-h-[90vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <button
              onClick={() => setHistoryModalOpen(false)}
              className="absolute top-4 right-4 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition"
            >
              <X className="w-5 h-5" />
            </button>

            <h2 className="text-sm sm:text-base font-bold text-gray-900 dark:text-gray-100 border-b border-gray-100 dark:border-gray-800 pb-2.5 flex items-center gap-2">
              <History className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-400" /> Tenant History & Profile
            </h2>
            ...
            {fetchingHistory ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3.5 bg-purple-50/70 dark:bg-purple-950/40 p-3.5 rounded-xl border border-purple-100/80 dark:border-purple-800/50">
                  ...
                  <div className="space-y-0.5 min-w-0">
                    <h3 className="font-bold text-gray-900 dark:text-gray-100 text-xs sm:text-sm truncate">
                      {selectedTenantHistory.name}
                    </h3>
                    <p className="text-[11px] sm:text-xs text-gray-600 dark:text-gray-300 flex items-center gap-1.5 truncate">
                ...
                <div>
                  <h4 className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 flex items-center gap-1">
                    <Building className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500" /> Recent Requests (First 3)
                  </h4>
                  ...
                  selectedTenantHistory.rentalRequests.length > 0 ? (
                    <div className="space-y-2">
                      {selectedTenantHistory.rentalRequests.slice(0, 3).map((req) => (
                        <div
                          key={req.id}
                          className="flex items-center justify-between p-3 border border-gray-100 dark:border-gray-800 rounded-xl bg-gray-50/60 dark:bg-gray-800/40 text-xs gap-2"
                        >
                    ...
                    <p className="text-xs text-gray-400 dark:text-gray-500 italic bg-gray-50 dark:bg-gray-800/50 p-3 rounded-xl text-center border border-gray-100 dark:border-gray-800">
              ...
              <p className="text-xs text-rose-500 dark:text-rose-400 text-center py-4">
                No data available.
              </p>
            )}
          </div>
